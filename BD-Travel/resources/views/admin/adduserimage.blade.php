      ...
      <div class="main_container">
       ...
       <div class="x_content">
                    <div class="container">
                      ...
                      <form action="/uploadimage" method="post" id="imageUpload" enctype="multipart/form-data">
                        {{@csrf_field()}}
                        ...
                        <input required="required" type="text" name="usernameSearch" id="usernameSearch" >Choose user<br>
                        <!-- <button id="submitbtn" type="submit" class="btn" style="margin-top: 7px">Upload</button> -->
                        <input id="submitbtn" type="submit" class="btn" name="submit" value="Upload" style="margin-top: 7px" >
