                      ...
                      <tbody>
                       ...
                       @foreach($users as $user)
                        <tr>
                          ...
                          <td>
                            <a href="#" class="btn btn-primary btn-xs" id="{{$user->id}}"><i class="fa fa-folder"></i> View </a>
                            
                            <a data-toggle="modal" data-target="#myModal"  href="#" class="btn btn-info btn-xs memberEdit"  id="{{$user->id}}"><i class="fa fa-pencil"></i> Edit </a>
                            
                            <a href="" data-toggle="modal" data-target="#deleteModal" class="btn btn-danger btn-xs delBtn"  id="{{$user->id}}"><i class="fa fa-trash-o"></i> Delete </a>
                          </td>
                        </tr>
                        @endforeach
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
        		<form action="{{route('editmembersubmit')}}" method="post" id="editForm">

                  {{@csrf_field()}}
                    <input type="hidden" class="hidden" id="custId" name="id" value="">
        			<div class="form-group">
        				<label for="order_name">Username</label>
        				<input type="text" class="form-control order_input username" name="order_name" id="order_name" placeholder="Enter username." onkeyup="userNameValidation()" onblur="document.getElementById('order_name_msg').innerHTML= '';" >
        			    <p id="order_name_msg"></p>
                    </div>
        			<div class="form-group">
        				<label for="order_email">Email Address</label>
        				<input type="text" class="form-control order_input email" name="order_email" id="order_email" placeholder="Enter  email address." onkeyup="ValidateEmail()" onblur="document.getElementById('order_email_msg').innerHTML= '';">
                      <p id="order_email_msg"></p>
                    </div>
        			<div class="form-group">
        				<label for="order_mobile">Phone Number</label>
        				<input type="text" class="form-control order_input mobile" name="order_mobile" id="order_mobile" placeholder="Enter mobile number">
                    </div>
...
<!-- / buy modal -->
          ...
          <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
              <div class="modal-dialog">
                  <div class="modal-content">
                      ...
                      <div class="modal-body">
                          <form action="{{route('deletemember')}}" method="post" id="">

                              {{@csrf_field()}}

                              <input type="hidden" class="delMemberHidden" value="" name="uid">
    ...
    <script src=" {{asset('js/searchUserAjax.js')}}"></script>
    <script src=" {{asset('js/editMemberValidation.js')}}"></script>
