				...
				<div class="row">
					<div class="col d-flex flex-row">
						...
						<div class="user_box ml-auto">
							...
							<div class="user_box_register user_box_link"><a href="{{route('user.profile')}}">Profile | </a></div>
				...
				<div class="col fill_height">
					...
					<div class="search_tabs_container">
						<div class="search_tabs d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
							...
							<div class="search_tab active d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="images/island.png" alt=""><span>Places</span></div>

							<div class="search_tab d-flex flex-row align-items-center justify-content-lg-center justify-content-start"><img src="images/suitcase.png" alt="">hotels</div>
					...
					<div class="search_panel active">
						<form action="{{route('user.placesearch')}}" id="search_form_1" class="search_panel_content d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">

							<div class="search_item">
								<div>Place Name</div>
								<input type="text" name="placename" class="destination search_input" required="required" id="desSearch">
							</div>
                            ...
                            <button type="submit" class="button search_button" id="searchBtn" style="margin-right: 500px">search<span></span><span></span><span></span></button>
						</form>
					</div>
					...
					<div class="search_panel">
						<form action="{{route('user.hotelsearch')}}" id="search_form_2" class="search_panel_content d-flex flex-lg-row flex-column align-items-lg-center align-items-start justify-content-lg-between justify-content-start">
				...
				@foreach($place as $place)
					<div class="col-lg-4 intro_col">
						<div class="intro_item">
							...
							<div class="intro_item_background" style="background-image:url(images/places/{{$place->image}})"></div>
							<div class="intro_item_content d-flex flex-column align-items-center justify-content-center">
								<div class="intro_date">May 25th - June 01st</div>
								<div class="button intro_button"><div class="button_bcg"></div><a href="{{route('user.placedetail',['id'=>$place->id])}}">see more<span></span><span></span><span></span></a></div>
								<div class="intro_center text-center">
									<h1>{{$place->subplacename}}</h1>
									<div class="intro_price">From {{$place->price}}</div>
						...
						<div class="row">
							<div class="col-lg-6">
								<div class="offers_image_container">
									...
									<div class="offers_image_background" style="background-image:url(images/hotel/{{$hotel->image}})"></div>
									<div class="offer_name"><a href="#">{{$hotel->hname}}</a></div>
								</div>
							</div>
							<div class="col-lg-6">
								<div class="offers_content">
									<div class="offers_price">{{$hotel->price}} BDT<span>per night</span></div>
									...
									<div class="offers_link"><a href="{{route('user.offer')}}">read more</a></div>
								</div>
							</div>
						</div>
					</div>
