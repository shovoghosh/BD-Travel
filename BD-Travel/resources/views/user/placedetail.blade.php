                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-1680-4">
                                    <div class="offers_image_container">
                                        ...
                                        <div class="offers_image_background" ><img style="height: 200px;width:250px" src="{{asset('images/places/'.$place->image)}}"></div>
                                        <div class="offer_name"><a href="single_listing.ejs">{{$place->subplacename}}</a></div>
                                    </div>
                                </div>
                                <div class="col-lg-8">
                                    <div class="offers_content">
                                        <div class="offers_price">{{$place->price}}<span></span></div>
                                        ...
                                        <p class="offers_text">{{$place->description}}</p>
