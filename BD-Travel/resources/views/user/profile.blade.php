    ...
    <div class="col-md-4">      
        <div class="portlet light profile-sidebar-portlet bordered">
            ...
            <div class="profile-usertitle">
                <div class="profile-usertitle-name"> Shuvo  </div>
            ...
            <div class="profile-usermenu">
                <ul class="nav">
                    ...
                    <li>
                        <a href="#">
                            <i class="icon-settings"></i> Previous Booking </a>
                    </li>
            ...
            <div class="portlet-body">
                <div>
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li role="presentation" ><a href="#home" aria-controls="home" role="tab" data-toggle="tab">Update</a></li>
                    ...
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane active" id="profile">Profile</div>
